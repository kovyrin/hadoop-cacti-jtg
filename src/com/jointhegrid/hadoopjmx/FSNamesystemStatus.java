 ...
 * @author ecapriolo
 */
public class FSNamesystemStatus {

  private String jmxURL;
  private String user;
  private String pass;
  private String objectName = "hadoop.dfs:name=FSNamesystemStatus,service=NameNode";
  private String[] wantedVariables = new String[]{"CapacityTotal", "CapacityUsed", "CapacityRemaining", "BlocksTotal", "FilesTotal"};
  private String[] wantedOperations = new String[]{"numDeadDataNodes", "numLiveDataNodes"};
